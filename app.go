...
func New(name, help string) *Application {
	...
	a.helpFlag.Bool()
	a.Flag("help-long", T("Generate long help.")).Hidden().PreAction(a.generateLongHelp).Bool()
	a.Flag("help-man", T("Generate a man page.")).Hidden().PreAction(a.generateManPage).Bool()
